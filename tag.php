...
$res = $q->fetchAll();
foreach ($res as $row) {
    //filtered post_ids[] matched by tag name
    ...
    <div class="row">
        ...
        <section class="blog mt50">
            <div class="col-md-9">
                ...
                <?php
                //select all post (post by post) and their user name
                $q = $pdo->prepare("
                    SELECT * 
                    FROM post t1
                    JOIN user t2
                ...
                if ($tot):
                    foreach ($res as $row) {
                        //filtered $post_ids[] matched by tag name if not matched skip those post
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-11 col-xs-10 meta">
                                    ...
                                    <span class="meta-category"><i class="fa fa-pencil"></i>
                                        ...
                                        <?php
                                        $i = 0;
                                        //select all post (post by post) and their category name
                                        $r = $pdo->prepare("
                                            SELECT * 
